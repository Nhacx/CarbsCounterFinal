...
$result = mysqli_query($conexao, "UPDATE usuarios set nome = '$nome' where id = '$id_usuario' ");
...
$result = mysqli_query($conexao, "UPDATE usuarios set peso = '$peso' where id = '$id_usuario' ");
...
$result = mysqli_query($conexao, "UPDATE usuarios set altura = '$altura' where id = '$id_usuario' ");
...
$result = mysqli_query($conexao, "UPDATE usuarios set email = '$email' where id = '$id_usuario' ");
...
$result = mysqli_query($conexao, "UPDATE usuarios set senha = '$senha' where id = '$id_usuario' ");

}

if($sexo != "")
  {
   $result = mysqli_query($conexao, "UPDATE usuarios set sexo = '$sexo' where id = '$id_usuario' ");
  }

if($nascimento)
  {
   $result = mysqli_query($conexao, "UPDATE usuarios set nascimento = '$nascimento' where id = '$id_usuario' ");
  }

 if($tipo_diabetes)
  {
   $result = mysqli_query($conexao, "UPDATE usuarios set tipo_diabetes = '$tipo_diabetes' where id = '$id_usuario' ");
  }
